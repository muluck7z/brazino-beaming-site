import { useState, useEffect } from "react";
    ...
    return (
      <>
        <style>{`
          ...
          .welcome-btn:hover { background: #155d33 !important; transform: translateY(-1px); box-shadow: 0 8px 24px rgba(27,115,64,0.45) !important; }
          .welcome-btn:active { transform: translateY(0) !important; }
          .step-card:hover { border-color: #1B7340 !important; background: #f0fbf4 !important; }
        `}</style>
        ...
        <div style={{
          ...
          <div style={{
            ...
            maxWidth: "460px",
            width: "100%",
            boxShadow: "0 24px 64px rgba(13,40,24,0.22)",
            ...
            <div style={{ textAlign: "center", marginBottom: "1.5rem" }}>
              <div style={{
                ...
                background: "#F0FBF4", border: "2px solid rgba(27,115,64,0.2)",
                marginBottom: "1rem",
              }}>
                <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#1B7340" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
                </svg>
              </div>
              <h2 style={{
                fontSize: "1.35rem", fontWeight: 800, color: "#0D2818",
                fontFamily: "Poppins, sans-serif", letterSpacing: "-0.01em", margin: 0,
              }}>
                Seja bem-vindo!
              </h2>
              <p style={{ marginTop: "0.4rem", color: "#6B7280", fontSize: "0.82rem", lineHeight: 1.5 }}>
                Aqui você aprenderá tudo sobre Beaming, desde a criação de links falsos até os métodos mais eficazes.
              </p>
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.625rem", marginBottom: "1.5rem" }}>
              ...
              <div className="step-card" style={{
                ...
                <div style={{
                  ...
                  background: "#1B7340", color: "#fff",
                  display: "flex", alignItems: "center", justifyContent: "center",
                  fontSize: "0.875rem", fontWeight: 700, fontFamily: "Poppins, sans-serif",
                }}>1</div>
                <div>
                  <p style={{ fontWeight: 700, color: "#0D2818", fontSize: "0.85rem", margin: 0 }}>
                    Categoria Tutorial
                  </p>
                  <p style={{ color: "#6B7280", fontSize: "0.78rem", marginTop: "0.2rem", lineHeight: 1.45 }}>
                    Aprenda a criar seu primeiro link falso passo a passo.
                  </p>
                </div>
              </div>
              ...
              <div className="step-card" style={{
                ...
                <div>
                  ...
                  <p style={{ color: "#6B7280", fontSize: "0.78rem", marginTop: "0.2rem", lineHeight: 1.45 }}>
                    Domine as técnicas essenciais que você usará no dia a dia.
                  </p>
                </div>
              </div>
            </div>
            ...
            <button
              ...
              style={{
                ...
                cursor: "pointer",
                boxShadow: "0 4px 16px rgba(27,115,64,0.35)",
  ...
  function AuthGate() {
    ...
    useEffect(() => {
      if (user) {
        const key = `brazino_welcomed_${user.id ?? "member"}`;
